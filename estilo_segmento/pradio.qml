...
<qgis hasScaleBasedVisibilityFlag="0" version="3.16.10-Hannover" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" maxScale="0" simplifyLocal="1" minScale="100000000" simplifyMaxScale="1">
  ...
  <renderer-v2 symbollevels="1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{aab5a632-a917-4c2f-adea-ac5db53f9087}">
      <rule label="Elementos atlas" key="{0c92cedb-56fe-47a1-a2b5-ce140b6580c1}" symbol="0" filter="attribute (@atlas_feature ,'radio') =  &quot;radio&quot;"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{cd85b449-12f7-4f4d-8aef-75a6878b1e80}">
      <rule key="{2dbfad80-f37c-45f6-be60-efb25c8c1c0d}" filter="attribute (@atlas_feature ,'radio') =  &quot;radio&quot;">
