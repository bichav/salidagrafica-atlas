...
<qgis version="3.16.10-Hannover" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" simplifyLocal="1" labelsEnabled="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement quadOffset="0" centroidWhole="1" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistance="0" centroidInside="0" maxCurvedCharAngleIn="25" placement="1" placementFlags="10" offsetType="0" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" fitInPolygonOnly="1" offsetUnits="Point" rotationAngle="0" repeatDistance="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" lineAnchorType="0" geometryGenerator="" overrunDistanceUnit="MM" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" geometryGeneratorEnabled="0" dist="0" layerType="PolygonGeometry" distUnits="MM"/>
