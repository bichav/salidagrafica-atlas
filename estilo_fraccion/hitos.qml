...
<qgis simplifyMaxScale="1" labelsEnabled="0" readOnly="0" minScale="100000000" version="3.16.10-Hannover" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{52335298-5509-4281-ab55-13184fb3ea95}">
      <rule filter="attribute (@atlas_feature , 'frac') = substr( &quot;link&quot; ,9,2) " key="{9956f1c2-c582-4a54-8dc7-b868b79ddddc}">
        <rule symbol="0" label="EDIFICIO" filter="&quot;valor&quot; = 'edificio'" key="{2197db45-7051-45d9-bd10-ee56babb723f}"/>
        <rule symbol="1" label="TERMINAL" filter="&quot;valor&quot; = 'terminal'" key="{ffe339e8-8717-4e01-8184-e9b72a6e5311}"/>
        <rule symbol="2" label="CEMENTERIO" filter="&quot;valor&quot; = 'CEMENTERIO'" key="{81600607-11c2-40c2-aeb5-e3637c0edb39}"/>
        <rule symbol="3" label="ESCUELA" filter="&quot;valor&quot; = 'ESCUELA'" key="{72562c28-bd43-4a43-ac87-df63a66f2bdb}"/>
        <rule symbol="4" label="ESTACION" filter="&quot;valor&quot; = 'ESTACION'" key="{0e1668b9-0234-4b72-b3da-cd704d90c13a}"/>
        <rule symbol="5" label="HOSPITAL" filter="&quot;valor&quot; = 'HOSPITAL'" key="{532115ea-e2ff-4625-b90a-f6b257e68729}"/>
        <rule symbol="6" label="IGLESIA" filter="&quot;valor&quot; = 'IGLESIA'" key="{39e50b87-83ca-45d2-becb-512a41b45c10}"/>
        <rule symbol="7" label="PLAZA" filter="&quot;valor&quot; = 'PLAZA'" key="{fcfbd36b-7baf-4b30-b0f1-71be53b83378}"/>
        <rule symbol="8" label="POLICIA" filter="&quot;valor&quot; = 'POLICIA'" key="{fc53e701-1734-480c-b492-e39503a02470}"/>
        <rule symbol="9" label="OTRO" filter="ELSE" key="{a079a266-858f-4721-b531-7352cc2e2121}"/>
      </rule>
    </rules>
    <symbols>
